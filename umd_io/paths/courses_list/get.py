...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["course_id", "name", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["course_id", "name", ], str]):
...
class GetCourseList(BaseApi):
    ...
    def get_course_list(
        ...
        return self._get_course_list_oapg(
