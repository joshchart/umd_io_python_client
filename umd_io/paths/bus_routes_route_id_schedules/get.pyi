...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['BusSchedule']:
            return BusSchedule

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['BusSchedule'], typing.List['BusSchedule']],
    ...
    def __getitem__(self, i: int) -> 'BusSchedule':
...
class GetSchedules(BaseApi):
    ...
    def get_schedules(
        ...
        return self._get_schedules_oapg(
